System.register(['@angular/core', '@angular/http', '../models/playlist-model', 'rxjs/add/operator/map', 'rxjs/Rx'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, playlist_model_1;
    var PlaylistService;
    return {
        setters:[
            function (core_1_1) {
            ...
            PlaylistService = (function () {
                ...
                PlaylistService.prototype.getPlaylists = function () {
                    if (this.playlists == null) {
                        ...
                        var p = new playlist_model_1.Playlist();
                        p.name = "Teste";
                        p.tracks = [];
                        this.addPlaylist(p);
                    }
